...
class CreateEmployeesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            // 外部キー制約 従テーブル側に書く このテーブルのデータが存在する限り、参照先のデータも削除されるべきでない場合は ->onDelete('restrict') 何も書かないと、デフォルトで ->onDelete('restrict')
            // 親テーブルのデータに対して、削除をしようとしたら、紐づいた子テーブルのデータがあれば、消すべきでは無い、->onDelete('restrict')　エラーが発生します。
