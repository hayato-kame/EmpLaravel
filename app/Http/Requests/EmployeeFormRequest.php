...
class EmployeeFormRequest extends FormRequest
{
     ...
     *
     * もし、アクセスの時のドメインより下のパスが'/employees/new_entry_edit'だったら
     * このFormRequestを利用する。それ以外は、許可しない。
     * $this->path()　は、 $request->path() のことです。
     * http://localhost:8000/employees/new_entry_edit?action=add
     * http://localhost:8000/employees/new_entry_edit?action=edit
    ...
    {
        if($this->path() == 'employees/new_entry_edit') {
